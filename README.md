...
A structured collection of comprehensive notes for core frontend technologies and frameworks.
...
- [HTML Notes](./1-Markup/HTML/HTML-Notes.md) — Core HTML concepts and best practices
- [HTML QA](./1-Markup/HTML/HTML-QA.md) — Questions and answers

### Markdown

- [Markdown Notes](./1-Markup/Markdown/Markdown-Notes.md) — Markdown syntax and usage

### Email

- [Email Notes](./1-Markup/Emails/Email-Notes.md) — Email HTML structure
- [Email QA](./1-Markup/Emails/Email-QA.md) — Common email questions
- [Email Sample 1](./1-Markup/Emails/Email-Sample-1.html) — Email template example
- [Email Sample 2](./1-Markup/Emails/Email-Sample-2.html) — Email template example
...
- [CSS Notes](./2-Styling/CSS/CSS-Notes.md) — CSS fundamentals and techniques
- [CSS QA](./2-Styling/CSS/CSS-QA.md) — Common CSS questions

### SCSS

- [SCSS Notes](./2-Styling/SCSS/SCSS-Notes.md) — SCSS preprocessing and features
- [SCSS QA](./2-Styling/SCSS/SCSS-QA.md) — SCSS questions
...
- [JavaScript Notes 1](./3-Scripting/Javascript/Javascript-Notes-1.md) — Core fundamentals
...
- [Vue Notes](./4-Framework/Vue/Vue-Notes.md) — Vue framework essentials
- [Vue QA](./4-Framework/Vue/Vue-QA.md) — Vue questions
...
- [AI Tools Notes](./5-Tooling/AI-Tools/AI-Tools-Notes.md) — AI-powered development tools

### Build Tools

- [Build Tools Notes](./5-Tooling/Build-Tools/) — Build system resources
